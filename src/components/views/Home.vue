<template>
  <div
    class="home-page container mx-auto  lg:px-0 lg:py-0 px-5 py-5"
  >
    <!-- Banner -->
    <div class="banner w-full lg:h-[90vh] h-50 bg-[url('/src/assets/images/image-banner.png')] bg-cover bg-no-repeat lg:rounded-none rounded-xl shadow relative lg:pl-30 pl-3"
    >
      <!-- Banner Title -->
    ...
    <div class="lg:mt-30 mt-15">
      <div class="Curated-Categories">
        ...
        <div
          ...
          <!-- card -->
          <div v-for="item in productStore.products.slice(0, 4)"
            :key="item.id"
    ...
    <div class="lg:mt-10 mt-5">
      <div class="Trending-Now">
        ...
        <div
          ...
          <!-- card -->
          <div v-for="item in productStore.products.slice(1,5)"
            :key="item.id"
            :class="mode.darkMode ? 'bg-[#1e293b] border border-[#334155]' : 'bg-white border border-gray-200'"
            class="lg:w-[23%] md:w-[48%] w-[48%] lg:h-125 h-72 shadow-xl  rounded-xl mb-5 overflow-hidden transition-all duration-300 hover:scale-[1.02] cursor-pointer "
          >
    ...
    >
      ...
      <div class="header-title text-center lg:text-left">
        ...
        >
          <div
          :class="mode.darkMode ? 'bg-white text-black' : 'bg-gray-500 text-white'"
          ...
          >
            ...
            :class="mode.darkMode ? ' text-black' : ' text-gray-200'"
             class="text-center  text-xs lg:text-sm">HOURS</p>
          </div>
          ...
          >
            ...
            <p :class="mode.darkMode ? ' text-black' : ' text-gray-200'"
             class="text-center  text-xs lg:text-sm">MINS</p>
          </div>
          ...
          >
            ...
            <p
            :class="mode.darkMode ? ' text-black' : ' text-gray-200'"
             class="text-center  text-xs lg:text-sm">SECS</p>
          </div>
        </div>
      </div>
    ...
    >
      <div
        :class="mode.darkMode ? 'bg-blue-800/10 backdrop-blur-xl border border-blue-800/20 text-white shadow-black' : 'bg-white text-gray-700'"
