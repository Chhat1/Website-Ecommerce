  ...
  <div :class="mode.darkMode ? 'bg-[#030712]' : 'bg-[#fafafa]'" 
    ...
    <form @submit.prevent="login"
      ...
      <div class="space-y-6 mb-8">
        ...
        <div>
          <div class="flex justify-between items-center mb-2">
            <label class="text-[10px] font-bold uppercase tracking-[0.2em]" 
                   :class="mode.darkMode ? 'text-slate-500' : 'text-slate-400'">Password</label>
            <router-link to="" class="text-[10px] font-bold uppercase tracking-[0.2em] text-indigo-500 hover:underline">
              Forgot?
            </router-link>
          </div>
      ...
      <p class="text-center text-sm font-light" :class="mode.darkMode ? 'text-slate-400' : 'text-slate-500'">
        ...
        <router-link to="/register" class="font-bold text-indigo-500 hover:underline">Sign up for free</router-link>
      </p>
    </form>
  </div>
</template>